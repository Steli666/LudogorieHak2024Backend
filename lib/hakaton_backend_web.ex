defmodule HakatonBackendWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: HakatonBackendWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: HakatonBackendWeb.Router,
        statics: HakatonBackendWeb.static_paths()
    end
  end
